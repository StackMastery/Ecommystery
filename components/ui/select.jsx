...
function SelectTrigger({ className, size = "default", children, ...props }) {
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "bg-[#1B191D] cursor-pointer outline-0 w-full justify-between flex items-center py-3 text-lg text-[#767577] px-5 rounded-full",
        className
      )}
      {...props}
    >
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          " bg-[#191919]/90 backdrop-blur-md overflow-hidden px-0 rounded-xl mt-2 z-[99999]",
          position === "popper" &&
