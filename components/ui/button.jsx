...
function Button({
  ...
  return (
    ...
    >
      {/* SVG Background */}
      <SVGGredient className="absolute transition-all blur-md group-hover:scale-150 group-hover:rotate-45 group-focus:scale-150 group-focus:rotate-45 inset-0 z-0" />
